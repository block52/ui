...
export default function BlockDetailPage() {
    ...
    // Decodes the Cosmos type URL directly out of the tx bytes (see
    // extractMessageTypeFromHex) so newly added message types are labelled
    // automatically, rather than matching against a hardcoded list.
    const extractMessageType = (hexTx: string): string => {
        try {
            return extractMessageTypeFromHex(hexTx) ?? "Unknown Message Type";
        } catch (err) {
            return "Unknown";
        }
    };
